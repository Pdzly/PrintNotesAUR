...
source=("git+https://github.com/RoBoT095/printnotes.git" "printnotes.desktop")
sha256sums=('SKIP'
            '354c3b8b032da2fe45153c097fdccfaa4ee2bb15c69325515fc16ef311046ac6')
...
package() {
    ...
    install -Dm644 printnotes.desktop "${pkgdir}/usr/share/applications/printnotes.desktop" 
    cd "${srcdir}/${_reponame}"
